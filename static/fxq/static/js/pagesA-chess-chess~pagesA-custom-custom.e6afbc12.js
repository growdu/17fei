(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[
  ...
  "0dd0": function (t, e, n) {
    ...
    var i = {
      computed: {
        value: function () {
          var t = this.text, e = this.mode, n = this.format, i = this.href;
          return "price" === e
            ? (/^\d+(\.\d+)?$/.test(t) ||
  ...
  "5f06": function (t, e, n) {
    ...
    var i = {
      props: {
        ...
        format: { type: [String, Function], default: uni.$u.props.text.format },
      ...
      a = {
        ...
        computed: {
          valueStyle: function () {
            ...
            return !this.type && (t.color = this.color),
        ...
        methods: {
          clickHandler: function () {
            this.call && "phone" === this.mode &&
            uni.makePhoneCall({ phoneNumber: this.text }), this.$emit("click");
          },
        },
      };
    e.default = a;
  ...
  c191: function (t, e, n) {
    "use strict";
    var i = n("42c7"), o = n.n(i);
    o.a;
  },
  c73d: function (t, e, n) {
    "use strict";
    var i = n("31d9"), o = n.n(i);
    o.a;
  },
  cd4c: function (t, e, n) {
    "use strict";
    ...
    var o = i(n("27d0")),
      r = {
        ...
        computed: {
          bemClass: function () {
            return this.color
              ? this.bem("button", ["shape", "size"], [
                "disabled",
                "plain",
                "hairline",
              ])
              : this.bem("button", ["type", "shape", "size"], [
                "disabled",
                "plain",
                "hairline",
              ]);
          ...
          iconColorCom: function () {
            return this.iconColor
              ? this.iconColor
              : this.plain
              ? this.color ? this.color : this.type
              : "info" === this.type
              ? "#000000"
              : "#ffffff";
          },
          ...
          nvueTextStyle: function () {
            var t = {};
            return "info" === this.type && (t.color = "#323233"),
        ...
        return t.show
          ? n("v-uni-view", {
            ...
            "price" === t.mode
              ...
              : t._e(),
            t.prefixIcon
              ? n("v-uni-view", { staticClass: "u-text__prefix-icon" }, [
                n("u-icon", {
                  attrs: {
                    name: t.prefixIcon,
            ...
            t.suffixIcon
              ? n("v-uni-view", { staticClass: "u-text__suffix-icon" }, [
                n("u-icon", {
                  attrs: {
                    name: t.suffixIcon,
                    customStyle: t.$u.addStyle(t.iconStyle),
