(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[
        ...
        a = {
          ...
          created: function () {
            null === this.isMaskClick && null === this.maskClick
              ? this.mkclick = !0
              : this.mkclick = null !== this.isMaskClick
                ? this.isMaskClick
                : this.maskClick,
        ...
        methods: {
          onOk: function () {
            "input" === this.mode
              ...
              : this.$emit("confirm"), this.beforeClose || this.popup.close();
          },
  ...
  "2bb8": function (t, e, n) {
    ...
    var i = {
      ...
      o = function () {
        ...
        return n("v-uni-view", { staticClass: "container" }, [
          n("u-navbar", {
            attrs: {
              title: t.title,
              placeholder: !0,
            ...
            t._l(t.customArr, function (e) {
              return n("uni-section", {
                ...
                attrs: {
                  maxlength: 35,
                  clearable: !0,
                  disabled: e.id == t.customArr[0].id ||
          ...
          n("uni-popup", { ref: "nameDialog", attrs: { type: "dialog" } }, [
            n("uni-popup-dialog", {
              attrs: {
                mode: "input",
                title: "游戏名称",
    ...
    var i = { uIcon: n("a6a2").default },
      o = function () {
        ...
        return n("v-uni-view", {
          ...
          n("v-uni-view", { staticClass: "u-input__content" }, [
        ...
        s = {
          ...
          computed: {
            stylesObject: function () {
              var t = (0, r.default)((0, r.default)({}, this.styles), {}, {
            ...
            transformStyles: function () {
              return "transform:" + this.transform + ";opacity:" +
                this.opacity + ";" + this.stylesObject;
            },
          },
          created: function () {
            this.config = {
          ...
          methods: {
            ...
            styleInit: function (t) {
              ...
              return "string" === typeof this.modeClass
                ? i(t, this.modeClass)
            ...
            animationType: function (t) {
              return {
                ...
                "zoom-in": "scaleX(".concat(t ? 1 : .8, ") scaleY(").concat(
                  t ? 1 : .8,
                  ")",
                ),
                "zoom-out": "scaleX(".concat(t ? 1 : 1.2, ") scaleY(").concat(
                  t ? 1 : 1.2,
                  ")",
                ),
              };
  ...
  a631: function (t, e, n) {
    ...
    var i = function () {
        var t = this, e = t.$createElement, n = t._self._c || e;
        return n("v-uni-view", { staticClass: "uni-popup-dialog" }, [
          n("v-uni-view", { staticClass: "uni-dialog-title" }, [
            n("v-uni-text", {
          ...
          "base" === t.mode
            ? n("v-uni-view", { staticClass: "uni-dialog-content" }, [
              t._t("default", [
                n("v-uni-text", { staticClass: "uni-dialog-content-text" }, [
                  t._v(t._s(t.content)),
                ]),
              ]),
            ], 2)
          ...
          n("v-uni-view", { staticClass: "uni-dialog-button-group" }, [
            n("v-uni-view", {
              ...
              n("v-uni-text", { staticClass: "uni-dialog-button-text" }, [
        ...
        computed: {
          otherBorderColor: function () {
            ...
            return "circle" === this.mode
              ? this.inactiveColor ? this.inactiveColor : t
              : "transparent";
          },
        },
  ...
  d5ca: function (t, e, n) {
    ...
    var i = function () {
        var t = this, e = t.$createElement, n = t._self._c || e;
        return n("v-uni-view", { staticClass: "uni-section" }, [
          n("v-uni-view", {
            ...
            t.type
              ...
              : t._t("decoration"),
            n("v-uni-view", { staticClass: "uni-section-header__content" }, [
              n("v-uni-text", {
            ...
            n("v-uni-view", { staticClass: "uni-section-header__slot-right" }, [
              t._t("right"),
            ], 2),
          ], 2),
          n(
  ...
  d643: function (t, e, n) {
        ...
        return (0, r.default)(t, [{
          ...
          value: function (t, e) {
            ...
            if (i = n || { styles: {}, config: {} }, s.includes(t)) {
              ...
              var o = "";
              "rotate" === t && (o = "deg"),
                i.styles.transform += "".concat(t, "(").concat(e + o, ") ");
    ...
    s.concat(["opacity", "backgroundColor"], [
      "width",
      "height",
      "left",
      "right",
        ...
        watch: {
          value: {
            ...
            handler: function (t, e) {
              this.innerValue = t,
                !1 === this.firstChange && !1 === this.changeFromInner &&
                this.valueChange(),
                this.firstChange = !1,
