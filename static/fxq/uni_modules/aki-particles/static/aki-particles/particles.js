...
var pJS = function (tag_id, params) {
  ...
  pJS.fn.retinaInit = function () {
    ...
    pJS.particles.size.anim.speed = pJS.tmp.obj.size_anim_speed *
      pJS.canvas.pxratio;
    ...
    pJS.interactivity.modes.bubble.distance = pJS.tmp.obj.mode_bubble_distance *
      pJS.canvas.pxratio;
    pJS.particles.line_linked.width = pJS.tmp.obj.line_linked_width *
      pJS.canvas.pxratio;
  ...
  pJS.fn.particle = function (color, opacity, position) {
    ...
    if (typeof (color.value) == "object") {
      if (color.value instanceof Array) {
        ...
        if (
          color.value.r != undefined && color.value.g != undefined &&
        ...
        if (
          color.value.h != undefined && color.value.s != undefined &&
  ...
  pJS.fn.interact.linkParticles = function (p1, p2) {
    ...
    if (dist <= pJS.particles.line_linked.distance) {
      var opacity_line = pJS.particles.line_linked.opacity -
        (dist / (1 / pJS.particles.line_linked
            .opacity)) / pJS.particles.line_linked.distance;

      if (opacity_line > 0) {
        /* style */
        var color_line = pJS.particles.line_linked.color_rgb_line;
        pJS.canvas.ctx.strokeStyle = "rgba(" + color_line.r + "," +
          color_line.g + "," + color_line.b +
          "," + opacity_line + ")";
  ...
  pJS.fn.modes.bubbleParticle = function (p) {
    ...
    if (
      ...
      isInArray(
        "bubble",
        pJS.interactivity.events.onhover
          .mode,
      )
    ) {
        ...
        if (ratio >= 0 && pJS.interactivity.status == "mousemove") {
          ...
          if (
            ...
            if (
              ...
              var opacity = p.opacity -
                (pJS.particles.opacity.value - pJS.interactivity.modes
                    .bubble.opacity) * ratio;
              if (
                opacity < p.opacity &&
                opacity >= pJS.interactivity.modes.bubble.opacity
              ) {
      ...
      isInArray(
        "bubble",
        pJS.interactivity.events.onclick
          .mode,
      )
    ) {
        ...
        if (bubble_param != particles_param) {
          if (!pJS.tmp.bubble_duration_end) {
            if (dist_mouse <= pJS.interactivity.modes.bubble.distance) {
              ...
              if (obj != bubble_param) {
                var value = p_obj -
                  (time_spent * (p_obj - bubble_param) / pJS.interactivity
                    .modes.bubble.duration);
  ...
  pJS.fn.vendors.densityAutoParticles = function () {
    if (pJS.particles.number.density.enable) {
      ...
      var nb_particles = area * pJS.particles.number.value /
