  ...
  e.prototype = {
    init: function () {
      ...
      return e._counter = 1e3,
        ...
        e._navigator = "undefined" != typeof window && window.navigator
          ? window.navigator
          : null,
        e.masterGain = null,
        e.noAudio = !1,
    ...
    _setupCodecs: function () {
      ...
      return e._codecs = {
        ...
        wav: !!(o.canPlayType('audio/wav; codecs="1"') ||
          o.canPlayType("audio/wav")).replace(/^no$/, ""),
        aac: !!o.canPlayType("audio/aac;").replace(/^no$/, ""),
        caf: !!o.canPlayType("audio/x-caf;").replace(/^no$/, ""),
        m4a: !!(o.canPlayType("audio/x-m4a;") || o.canPlayType("audio/m4a;") ||
          o.canPlayType("audio/aac;")).replace(/^no$/, ""),
        m4b: !!(o.canPlayType("audio/x-m4b;") || o.canPlayType("audio/m4b;") ||
          o.canPlayType("audio/aac;")).replace(/^no$/, ""),
        ...
        flac: !!(o.canPlayType("audio/x-flac;") || o.canPlayType("audio/flac;"))
          .replace(/^no$/, ""),
      },
        e;
    },
    _unlockAudio: function () {
      ...
      if (!e._audioUnlocked && e.ctx) {
        e._audioUnlocked = !1,
          e.autoUnlock = !1,
          e._mobileUnloaded || 44100 === e.ctx.sampleRate ||
    ...
    _obtainHtml5Audio: function () {
      ...
      return o && "undefined" != typeof Promise &&
    ...
    _autoSuspend: function () {
      var e = this;
      if (
        e.autoSuspend && e.ctx && void 0 !== e.ctx.suspend && n.usingWebAudio
      ) {
    ...
    _autoResume: function () {
      ...
      if (e.ctx && void 0 !== e.ctx.resume && n.usingWebAudio) {
        return "running" === e.state && "interrupted" !== e.ctx.state &&
            e._suspendTimer
  ...
  o.prototype = {
    init: function (e) {
      ...
      return n.ctx || _(),
        ...
        o._xhr = {
          ...
          withCredentials: !(!e.xhr || !e.xhr.withCredentials) &&
    ...
    load: function () {
      ...
      return o
        ? (e._src = o,
          e._state = "loading",
          "https:" === window.location.protocol && "http:" === o.slice(0, 5) &&
      ...
      if ("number" == typeof e) r = e, e = null;
        ...
        if (void 0 === e && (e = "__default", !t._playLock)) {
          for (var a = 0, u = 0; u < t._sounds.length; u++) {
            t._sounds[u]._paused && !t._sounds[u]._ended &&
              (a++, r = t._sounds[u]._id);
          }
          1 === a ? e = null : r = null;
        }
      ...
      for (var t = o._getSoundIds(e), r = 0; r < t.length; r++) {
        ...
        a &&
          (a._seek = a._start || 0,
            ...
            a._node &&
            (o._webAudio
              ? a._node.bufferSource && (void 0 === a._node.bufferSource.stop
    ...
    loop: function () {
      ...
      for (var a = t._getSoundIds(n), u = 0; u < a.length; u++) {
        (o = t._soundById(a[u])) &&
          (o._loop = e,
            t._webAudio && o._node && o._node.bufferSource &&
    ...
    seek: function () {
      ...
      if (d) {
        ...
        s && t.pause(o, !0),
          ...
          d._ended = !1,
          t._clearTimer(o),
          t._webAudio || !d._node || isNaN(d._node.duration) ||
    ...
    unload: function () {
      ...
      for (t = 0; t < n._howls.length; t++) {
        if (
          n._howls[t]._src === e._src || e._src.indexOf(n._howls[t]._src) >= 0
        ) {
          u = !1;
          break;
        }
    ...
    _emit: function (e, n, o) {
      for (var t = this, r = t["_on" + e], a = r.length - 1; a >= 0; a--) {
        r[a].id && r[a].id !== n && "load" !== e || (setTimeout(
          function (e) {
            e.call(this, n, o);
          }.bind(t, r[a].fn),
          0,
    ...
    _ended: function (e) {
      ...
      if (
        !o._webAudio && e._node && !e._node.paused && !e._node.ended &&
    ...
    _cleanBuffer: function (e) {
      ...
      if (
        n._scratchBuffer && e.bufferSource &&
  ...
  var r = {},
    ...
    _ = function () {
      if (n.usingWebAudio) {
        ...
        n.usingWebAudio &&
        (n.masterGain = void 0 === n.ctx.createGain
          ? n.ctx.createGainNode()
          : n.ctx.createGain(),
          ...
          n.masterGain.connect(n.ctx.destination)), n._setup();
      }
    };
      ...
      for (var a = i._getSoundIds(o), s = 0; s < a.length; s++) {
        ...
        if (p) {
          ...
          p._orientation = [n, t, r],
            p._node &&
            (p._panner ||
              (p._pos || (p._pos = i._pos || [0, 0, -.5]), e(p, "spatial")),
        ...
        if (r = o._soundById(a[s])) {
          ...
          p = {
            ...
            distanceModel: void 0 !== n.distanceModel
              ? n.distanceModel
              : p.distanceModel,
            maxDistance: void 0 !== n.maxDistance
              ? n.maxDistance
              : p.maxDistance,
            refDistance: void 0 !== n.refDistance
              ? n.refDistance
              : p.refDistance,
